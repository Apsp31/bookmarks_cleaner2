# Requirements Archive: v1.1 Quality & Navigation
...
- [x] **DND-02**: Drop targets are visually highlighted during drag; invalid targets are not highlighted
- [x] **DND-03**: Reorder persists to session (survives page refresh during the review workflow)
- [x] **DND-04**: Drag interactions do not conflict with existing right-click context menu
